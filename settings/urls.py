...
urlpatterns = [
    ...
    path('api/rooms/book/<room_id>/', BookRoomAPIView.as_view(), name='book-room'),
    path('api/reservations/', UserReservationsAPIView.as_view(), name='reservation-list'),
    path('api/reservations/cancel/<room_id>/', CancelReservationAPIView.as_view(), name='cancel-reservation'),
